...
require_pattern web/admin/src/main.tsx 'label="素材分组"' "resource upload uses business wording for material grouping"
...
reject_pattern web/admin/src/main.tsx '活跃资源|资源健康|暂无资源失败样本|CONFIG_RESOURCE_UPSERT: "资源变更"|CONFIG_RESOURCE_DELETE: "资源删除"' "overview and audit avoid backend resource wording"
